...
const translations: Record<Language, Record<string, string>> = {
  no: {
    ...
    'community.freeCoursesTitle': 'Gratis kurs',
    'community.freeCoursesDesc': 'Få tilgang til vår samling av gratis AI-kurs og veiledninger for å forbedre ferdighetene dine.',
    'community.browseCourses': 'Se kurs',
  ...
  en: {
    ...
    'community.freeCoursesTitle': 'Free Courses',
    'community.freeCoursesDesc': 'Access our collection of free AI courses and tutorials to level up your skills.',
