...
const translations: Record<Language, Record<string, string>> = {
  no: {
    ...
    'home.hero.body': 'Jeg hjelper privatpersoner, bedrifter og team å bruke AI-verktøy, AI coding (rask, utforskende koding med AI-verktøy) og automasjon for å lære raskere, spare tid og skape bedre resultater.',
  ...
  en: {
    ...
    'home.hero.body': 'I help individuals (privatpersoner), creators and teams use AI tools, vibe coding (fast, exploratory coding with AI tools) and automation to learn faster, save time and create better results.',
